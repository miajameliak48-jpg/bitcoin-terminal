...
import { useChartStore, useSignalStore, useTickerStore, useOrderBookStore, useTradeStore, useBalanceStore } from '../store';
...
export function useSocket() {
  ...
  useEffect(() => {
    ...
    s.on('balance:update', (b: number) => setBalance(b, false));
